...
const freeFireConfig = {
    ...
    "cdn_url": "https://bot-api.junofficial.biz.id/cdn",
    "abhotupdate_cdn_url": "https://bot-api.junofficial.biz.id/cdn",
    "backup_cdn_url": "https://bot-api.junofficial.biz.id/cdn",
    ...
    "network_log_server": "https://bot-api.junofficial.biz.id/api/network_log",
    "web_log_server": "https://bot-api.junofficial.biz.id/web_log",
    "login_failed_count": 4,
    "test_url": "https://bot-api.junofficial.biz.id/",
    "img_cdn_url": "https://bot-api.junofficial.biz.id/cdn",
    ...
    "multi_region": ""
    // Masukkan sisa payload JSON di sini
};

app.get('/config', (req, res) => {
    res.setHeader('Content-Type', 'application/json');
    res.status(200).json(freeFireConfig);
});
